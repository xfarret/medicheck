...
{
    public function __construct(EntityManager $entityManager, $userClass = 'App\Entity\User')
    {
    ...
    private function getUserWithGroupsBySelector($selectorName, $value)
    {
        ...
        try {
            ...
            throw new UsernameNotFoundException(
                sprintf('Unable to find an active admin User object identified by "%s".', $value),
                0, $e
            );
        } catch(NonUniqueResultException $ne) {
            throw new UsernameNotFoundException(
                sprintf('Non unique User object found identified by "%s".', $value),
                0, $ne
            );
        }
